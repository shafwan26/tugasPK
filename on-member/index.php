...
<body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div id="home">
        ...
        <div id="slides" class="carousel slide" data-ride="carousel" data-interval="7000">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active" style="background-image:url(../assets/img/bg/background.jpg);">
                    <div class="carousel-caption text-center">
                        <h1>Welcome To Nabil Store</h1>
                ...
                <div class="carousel-item" style="background-image:url(../assets/img/bg/background2.jpg);"></div>
                <div class="carousel-item" style="background-image:url(../assets/img/bg/background1.jpg);"></div>
    ...
    <div class="row jumbotron welcome">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 col-xl-10">
            <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis assumenda dignissimos veniam dicta magnam, molestias deserunt. Reprehenderit totam quo, velit, dignissimos ducimus consequuntur voluptatum at voluptas molestias excepturi fugit corrupti!</p>
        </div>
        <!-- </div> -->
        ...
        <div class="container-fluid padding alat">
            <div class="row text-center padding">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="card">
                        <img src="../assets/img/bg/images.jpg" class="card-img-top">
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="font-weight-bold">Popped!</div>
                                <div class="text-danger">Rp.10.000</div>
                            </div>
                            <hr class="my-4">
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 thumbnail">
                    <div class="card">
                        <img src="../assets/img/bg/images2.jpg" class="card-img-top">
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="font-weight-bold">Sotong Panggang</div>
                                <div class="text-danger">Rp.65.000</div>
                            </div>
                            <hr class="my-4">
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 thumbnail">
                    <div class="card">
                        <img src="../assets/img/bg/images1.jpg" class="card-img-top">
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="font-weight-bold">Bento</div>
                                <div class="text-danger">Rp.50000</div>
                            </div>
                            <hr class="my-4">
                        </div>
                    </div>
            ...
            <div class="container mt-5">
                ...
                <div class="row">
                    <div class="col-md-12 text-center mt-2">
                        <p>
                            &copy;Copyright with Bootstrap 4 theme 2019 design
